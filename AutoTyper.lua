...
KeyGui.Name = "BrutForceKeySystem"
...
DiscordButton.Position = UDim2.new(0.3, 0, 0.85, 0)
...
local function animateButton(button, hoverColor)
    ...
    button.MouseLeave:Connect(function()
        TweenService:Create(button, TweenInfo.new(0.1), {
            BackgroundColor3 = button == DiscordButton and Color3.fromRGB(88, 101, 242) or colors.primary,
            Size = button.Size - UDim2.new(0.02, 0, 0.05, 0)
        }):Play()
    end)
end

animateButton(CheckButton, Color3.new(colors.primary.R * 1.3, colors.primary.G * 1.3, colors.primary.B * 1.3))
animateButton(DiscordButton, Color3.new(0.4, 0.5, 1))

-- Кнопка Discord
DiscordButton.MouseButton1Click:Connect(function()
    pcall(function()
        setclipboard("https://discord.gg/sn6BGaeBKQ")
    end)
...
CheckButton.MouseButton1Click:Connect(function()
    if KeyBox.Text == "AutoTypeUPD" then
